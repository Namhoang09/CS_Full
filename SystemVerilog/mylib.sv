package mylib;
    ...
    // ── Độ rộng bit ────────────────────────────────────────────────────────
    parameter int Psi_W   = 16;  // Psi_INT: int16 (Q1.14 sau scaling)
    parameter int A_W     = 32;  // output A stream: int32
    ...
    parameter int TACC_W  = 32;  // accumulator A_Engine
    parameter int SACC_W  = 64;  // accumulator srec trong Recon_SSE

    // ── Fixed-point ────────────────────────────────────────────────────────
    parameter int FRAC_Psi      = 14;  
